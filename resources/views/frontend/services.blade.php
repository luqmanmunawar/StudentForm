    ...
    <div class="container">
        ...
        <div class="section-title text-center">
            ...
            <p class="lead">
                ...
                social media support, we provide corporate identity and graphic
                design services.
            </p>
        ...
        <div class="owl-services owl-carousel owl-theme">
            ...
            <div class="service-widget">
                ...
                <div class="post-media wow fadeIn">
                    ...
                    <img
                        src="{{ asset('theme-1/uploads/service_01.jpg') }}"
                        alt=""
            ...
            <div class="service-widget">
                ...
                <div class="post-media wow fadeIn">
                    ...
                    <img
                        src="{{ asset('theme-1/uploads/service_02.jpg') }}"
                        alt=""
                        class="img-responsive img-rounded"
                    >
            ...
            <div class="service-widget">
                ...
                <div class="post-media wow fadeIn">
                    ...
                    <img
                        src="{{ asset('theme-1/uploads/service_03.jpg') }}"
                        alt=""
                        class="img-responsive img-rounded"
                    >
            ...
            <div class="service-widget">
                ...
                <div class="post-media wow fadeIn">
                    ...
                    <img
                        src="{{ asset('theme-1/uploads/service_04.jpg') }}"
                        alt=""
                        class="img-responsive img-rounded"
                    >
