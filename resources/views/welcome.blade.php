...
<div class="slider-area">
    <div class="slider-wrapper owl-carousel">
        ...
        <!-- Slider 1 -->
        <div class="slider-item home-one-slider-otem slider-item-four"
             style="background-image: url('{{ asset('theme-1/uploads/slider_01.jpg') }}');">
                    ...
                    <div class="slider-content-area">
                        <div class="slide-text">
                            ...
                            <div class="slider-content-btn">
                                <a class="button btn btn-light btn-radius btn-brd" href="#">
                                    Read More
                                </a>
        ...
        <div class="slider-item text-center home-one-slider-otem slider-item-four"
             style="background-image: url('{{ asset('theme-1/uploads/slider_02.jpg') }}');">
        ...
        <!-- Slider 3 -->
        <div class="slider-item home-one-slider-otem slider-item-four"
             style="background-image: url('{{ asset('theme-1/uploads/slider_03.jpg') }}');">
...
<div class="parallax section parallax-off"
     ...
     style="background-image: url('{{ asset('theme-1/uploads/parallax_04.jpg') }}');">
    ...
    <div class="container">
        ...
        <div class="row text-center stat-wrap">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                ...
                <span class="global-radius icon_wrap effect-1">
...
<div class="owl-services owl-carousel owl-theme">
    <div class="service-widget">
        <div class="post-media wow fadeIn">
            <a href="{{ asset('theme-1/uploads/service_01.jpg') }}" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
            <img src="{{ asset('theme-1/uploads/service_01.jpg') }}" alt="" class="img-responsive img-rounded">
        </div>
    ...
    <div class="service-widget">
        <div class="post-media wow fadeIn">
            <a href="{{ asset('theme-1/uploads/service_02.jpg') }}" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
            <img src="{{ asset('theme-1/uploads/service_02.jpg') }}" alt="" class="img-responsive img-rounded">
        </div>
        <div class="service-dit">
    ...
    <div class="service-widget">
        <div class="post-media wow fadeIn">
            <a href="{{ asset('theme-1/uploads/service_03.jpg') }}" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
            <img src="{{ asset('theme-1/uploads/service_03.jpg') }}" alt="" class="img-responsive img-rounded">
        </div>
        <div class="service-dit">
    ...
    <div class="service-widget">
        <div class="post-media wow fadeIn">
            <a href="{{ asset('theme-1/uploads/service_04.jpg') }}" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
            <img src="{{ asset('theme-1/uploads/service_04.jpg') }}" alt="" class="img-responsive img-rounded">
        </div>
        <div class="service-dit">
...
<div class="parallax section noover" data-stellar-background-ratio="0.7" style="background-image: url('{{ asset('theme-1/uploads/parallax_05.png') }}');">
    <div class="container">
        <div class="row text-center">
            <div class="col-md-6">
                <div class="customwidget text-left">
                    ...
                    <a href="#services" data-scroll class="btn   -light btn-radius btn-brd">Learn More</a>
                </div>
            </div><!-- end col -->

            <div class="col-md-6">
                <div class="text-center image-center hidden-sm hidden-xs">
                    <img src="{{ asset('theme-1/uploads/device_03.png') }}" alt="" class="img-responsive wow fadeInUp">
                </div>
            </div>
        </div><!-- end row -->
    </div><!-- end container -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 hidden-xs hidden-sm">
                <img src="{{ asset('theme-1/uploads/ipad.png') }}" class="img-center img-responsive" alt="">
            </div>
...
<div id="testimonials" class="parallax section db parallax-off" style="background-image: url('{{ asset('theme-1/uploads/parallax_03.jpg') }}');">
    <div class="container">
        <div class="section-title text-center">
            <h3>Testimonials</h3>
                ...
                <div class="testi-carousel owl-carousel owl-theme">
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('theme-1/uploads/testi_01.png') }}" alt="" class="img-responsive alignleft">
                    ...
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('theme-1/uploads/testi_02.png') }}" alt="" class="img-responsive alignleft">
                    ...
                    <div class="testimonial clearfix">
                        ...
                        <div class="testi-meta">
                            <img src="{{ asset('theme-1/uploads/testi_03.png') }}" alt="" class="img-responsive alignleft">
        ...
        <div class="row logos">
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('theme-1/uploads/logo_01.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('theme-1/uploads/logo_02.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('theme-1/uploads/logo_03.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('theme-1/uploads/logo_04.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('theme-1/uploads/logo_05.png') }}" alt="" class="img-repsonsive"></a>
            </div>
            <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                <a href="#"><img src="{{ asset('theme-1/uploads/logo_06.png') }}" alt="" class="img-repsonsive"></a>
            </div>
        </div><!-- end row -->
